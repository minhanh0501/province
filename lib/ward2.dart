...
List<Province> provinceList = []; // Định nghĩa biến provinceList
List<District> districtList = []; // Định nghĩa biến districtList
List<Ward> wardList = []; // Định nghĩa biến wardList
